...
{\textit{\LARGE Second revised and improved edition}}
}

\renewcommand{\lsImpressumCitationText}{%
Pérez Vidal, Carmen, Sonia López-Serrano, Jennifer Ament \& Dakota J. Thomas-Wilhelm (eds.). 2019. \textit{Learning context effects. Study abroad, formal instruction and international immersion classrooms. Second revised and improved edition.} (Eurosla Studies 1). Berlin: Language Science Press. 
}
